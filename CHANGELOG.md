...
## [27.0.0](https://github.com/leordev/existing-sandbox/compare/v26.1.2...v27.0.0) (2025-05-20)


### ⚠ BREAKING CHANGES

* apply TypeScript rules to additional filetypes ([#838](https://github.com/leordev/existing-sandbox/issues/838))

### Features

* add TypeScript type-checking to JavaScript files and export type declarations ([#723](https://github.com/leordev/existing-sandbox/issues/723)) ([f538494](https://github.com/leordev/existing-sandbox/commit/f53849433dd44fbbd49978b5af11c06e222718a7))
* apply TypeScript rules to additional filetypes ([#838](https://github.com/leordev/existing-sandbox/issues/838)) ([f9f0912](https://github.com/leordev/existing-sandbox/commit/f9f0912afaeaaaea8d24b33b34df07de71446833))
...
* expose ASYNC_EMBER_TEST_HELPERS in Node API ([7533e37](https://github.com/leordev/existing-sandbox/commit/7533e37c92d6d66823e198186e37f37a4eb71b25))
* make paths option optional in no-restricted-files rule ([#753](https://github.com/leordev/existing-sandbox/issues/753)) ([d828150](https://github.com/leordev/existing-sandbox/commit/d828150850b398c84ec0ec6822d38e2e0fd9c1b5))
...
* adjust package name ([b516554](https://github.com/leordev/existing-sandbox/commit/b516554d96e0a7fa3cd3375b560eaa00bd905726))
* adjust the package name for testing releases ([153a633](https://github.com/leordev/existing-sandbox/commit/153a6338f17e1f8fda42bbf657d398e27a92a9c7))
* allow direct return of required-await-functions ([cb36ab4](https://github.com/leordev/existing-sandbox/commit/cb36ab445ba09b68d3b8229ff5845cdd8d585653))
* allow placeholder addon dummy app types file generated by ember-cli-typescript blueprint ([#698](https://github.com/leordev/existing-sandbox/issues/698)) ([e125b98](https://github.com/leordev/existing-sandbox/commit/e125b980f0fe74bb0d7b2591770448aaf287edbd))
* automatically provide square plugin so consumers don't have to specify it ([d2fe917](https://github.com/leordev/existing-sandbox/commit/d2fe917c430646e1127147e1b92315fc3cf97293))
...
* **ci:** prep release ([01bdda9](https://github.com/leordev/existing-sandbox/commit/01bdda94ae768577fe79965f573c33aa2b649ca6))
* **ci:** use releaser ([693de44](https://github.com/leordev/existing-sandbox/commit/693de44e66a028b261e10bb96dbbbed4adbf8487))
* ignore assignment in require-await-function rule ([#706](https://github.com/leordev/existing-sandbox/issues/706)) ([dcc9b10](https://github.com/leordev/existing-sandbox/commit/dcc9b100dfaede590db04b631514d58731f00adc))
...
* switch to messageIds for reporting violations ([4986c73](https://github.com/leordev/existing-sandbox/commit/4986c73f78c1bdfcb595cc830367e62cece68615))
